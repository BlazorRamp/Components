...
public partial class DataColumn<TData> : ColumnBase<TData>
{
    ...
    protected override void OnInitialized()
    {
        ...
        if (IsSortable && false == DataTableHelper.IsComparableType(PropertyInfo!))
        {
            throw new InvalidOperationException(String.Format(GlobalValues.DataTable_Column_Not_Comparable_Exception_Message, _fieldName, PropertyInfo!.PropertyType.Name));
        }
