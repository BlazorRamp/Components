...
1. Add the BlazorRamp.Tooltip nuget package to your project using the Nuget Package Manager or the dotnet CLI.

```c#
dotnet add package BlazorRamp.Tooltip
```
2. Add the following Core and Tooltip stylesheet references to the `<head>` section of your application:
