...
internal class GlobalValues
{
    ...
    public const string JavaScript_File_Path        = "./_content/BlazorRamp.Components/assets/js/modal-Dialog.js";
    ...
    public const string DialogFramework_Class        = "br-dialog-framework";
