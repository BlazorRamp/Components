...
using TextInputComponent = BlazorRamp.Inputs.Components.TextInput;
...
public class TextInput_Tests
{
    ...
    public static (IRenderedComponent<TextInputComponent> Component, EditContext EditContext) CreateInputWithParamByName<TValue>(BunitContext context, string paramName, TValue paramValue)
    {
    ...
    public class Parameters()
    {
        ...
        public async Task Should_be_able_to_set_required_which_uses_aria_required_if_true(bool required)
        {
            ...
            var (inputComponent, _) = CreateInputWithParamByName<bool>(context, nameof(TextInputComponent.Required), required);
        ...
        public async Task Should_be_able_to_set_the_readonly_attribute_when_true(bool readOnly)
        {
            ...
            var (inputComponent, _) = CreateInputWithParamByName<bool>(context, nameof(TextInputComponent.ReadOnly), readOnly);
        ...
        public async Task Should_be_able_to_set_the_aria_disabled_attribute_when_true(bool disabled)
        {
            ...
            var (inputComponent, _) = CreateInputWithParamByName<bool>(context, nameof(TextInputComponent.AriaDisabled), disabled);
        ...
        public async Task Should_be_able_to_set_the_control_id_param_or_have_a_guid_string_if_null_empty_or_whitespace(string? controlID)
        {
            ...
            var (inputComponent, _) = CreateInputWithParamByName<string?>(context, nameof(TextInputComponent.ControlID), controlID);
        ...
        public async Task Should_be_able_to_set_the_hint_text_normalised_so_it_ends_with_a_full_stop(string? hintText)
        {
            ...
            var (inputComponent, _) = CreateInputWithParamByName<string?>(context, nameof(TextInputComponent.HintText), hintText);

            var hints = inputComponent.FindAll($".{GlobalValues.Text_Input_Hint_Class}");
        ...
        public async Task Should_have_a_tabbable_region_for_errors_when_the_Validation_display_mode_is_set_to_tabbable_with_hint()
        {
            ...
            var (inputComponent, editContext) = CreateInputWithParamByName<ValidationDisplayMode?>(context,nameof(TextInputComponent.ValidationDisplayMode), ValidationDisplayMode.TabbableWithHint);
            ...
            inputComponent.WaitForAssertion(() =>
            {
                ...
                var errorDiv = inputComponent.Find($".{GlobalValues.Text_Input_Error_Class}");
        ...
        public async Task Should_be_able_to_set_the_update_on_input_param(bool updateOnInput)
        {
            ...
            var (inputComponent, _) = CreateInputWithParamByName<bool?>(context, nameof(TextInputComponent.UpdateOnInput), updateOnInput);
        ...
        [Theory]
        [InlineData(TextInputType.Tel)]
        [InlineData(TextInputType.Text)]
        [InlineData(TextInputType.Email)]
        [InlineData(TextInputType.Url)]
        public async Task Should_be_able_to_set_the_input_type_param(TextInputType inputType)
        {
            await using var context = new BunitContext();
        ...
        [Fact]
        public async Task The_input_type_should_be_set_to_text_if_text_input_type_param_is_not_provided()
        {
            await using var context = new BunitContext();

            var (inputComponent, _) = CreateInputWithParamByName<bool?>(context, nameof(TextInputComponent.Required), true);
