    ...
    public const string Text_Input_Example = """
        ...
        @code {
            ...
            protected override void OnInitialized()
            {
                ...
                var firstNameValidator = MemberValidators.CreateStringRegexValidator(@"^(?=.{2,50}$)[A-Z]+['\- ]?[A-Za-z]*['\- ]?[A-Za-z]+$", "FirstName", 
                                                                                     "First name", "Must start with a capital letter and be between 2 and 50 characters in length");
                /*
