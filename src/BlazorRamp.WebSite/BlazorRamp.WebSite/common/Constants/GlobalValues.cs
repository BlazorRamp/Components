...
public static class GlobalValues
{
    ...
    public const string Path_About_Blazor_Ramp = "/about-blazor-ramp";
    public const string Path_Home                 = "/";
    public const string Path_Busy_Screen          = "/busy-page";
    public const string Path_Busy_Container       = "/busy-container";
    public const string Path_Modal_Busy_Screen    = "/modal-busy-page";
    public const string Path_Busy_Short           = "/busy-short";
    public const string Path_Final_Words          = "/final-words";

    public const string Title_About_Blazor_Ramp    = "About Blazor Ramp";
    public const string Title_Busy_Screen          = "Busy Page Test";
    public const string Title_Home_Screen          = "Home";
    public const string Title_Busy_Container       = "Busy Container Test";
    public const string Title_Modal_Busy_Screen    = "Modal Busy Page Test";
